...
const Process = () => {
  ...
  return (
    <section id="process" className="section-spacing px-6 relative overflow-hidden">
      {/* Background accent */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stages.map((stage, index) => {
            ...
            return (
              <div 
                key={index}
                className="glass glass-hover p-8 rounded-xl flex flex-col items-start animate-fade-up hover:scale-[1.02] transition-all duration-300"
