...
const Header = () => {
  ...
  return <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'backdrop-blur-md bg-background/90 shadow-sm border-b border-border/40' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <a href="#home" className="hover:opacity-80 transition-opacity flex items-center gap-2">
            <img src="/lovable-uploads/d57e18cf-ef2b-43ec-84cc-a8bcb2c88158.png" alt="Apply Logo" className="h-28 transform transition-all duration-300 hover:scale-110 hover:rotate-2 hover:brightness-110" />
          </a>
