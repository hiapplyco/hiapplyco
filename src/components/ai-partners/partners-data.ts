...
export const aiPartnersData: AIPartner[] = [
  ...
  { name: "v0", logo: "/v0_dark.svg", delay: 0.8, orbit: 320, speed: 0.55 },
  { name: "Groq", logo: "/groq.svg", delay: 0.9, orbit: 180, speed: 1.4 },
  { name: "Deepseek", logo: "/deepseek.svg", delay: 1.0, orbit: 280, speed: 0.75 },
  { name: "Meta AI", logo: "/meta.svg", delay: 1.1, orbit: 400, speed: 0.4 },
  { name: "Runway", logo: "/runway.svg", delay: 1.2, orbit: 230, speed: 0.85 },
  { name: "Replit", logo: "/replit.svg", delay: 1.3, orbit: 360, speed: 0.5 },
  { name: "Gradio", logo: "/gradio.svg", delay: 1.4, orbit: 250, speed: 0.8 },
  { name: "OpenWebUI", logo: "/openwebui.svg", delay: 1.5, orbit: 310, speed: 0.6 }
];
